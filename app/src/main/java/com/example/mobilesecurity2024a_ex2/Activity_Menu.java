...
import com.example.mobilesecurity2024a_ex2.R;
...
public class Activity_Menu extends AppCompatActivity {
    ...
    private void startGame(String id, String data) {
        if (id != null && id.length() >= 8) { // Check if id is not null and has at least 8 characters
            ...
            // Handle the case where id is null or does not have enough characters
            Log.e("Activity_Menu", "Invalid id: " + id);
        }
    }
